...
image: '/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/cover.png'
---

![How to use Screen on Linux to Detach and Reattach your Terminal](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/cover.png)
...
![Screen License](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-license-screen.png)
...
![Screen Session](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-session-attached.png)

Now, we are going to detach from the session using **Clrl+A** and then press **d**.

![Screen Detached](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-session-detached.png)

now lets list out the `screen` windows using the `-ls` (list) option

![Screen session list](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-session-list.png)

We are can use the `-r` (reattach) option and the number of the session to reattach to it

![Screen session reattached](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-session-reattach.png)

And just like that, you're back working on your download. 😄

![Screen session reattached result](/blog/how-to-use-screen-on-linux-to-detach-and-reattach-your-terminal/screen-session-reattach-result.png)
