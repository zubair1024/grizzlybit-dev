...
summary: 'Node.js 24 is here with game-changing features like V8 13.6, Float16Array, explicit resource management, WebAssembly Memory64, and npm 11. Learn what's new, breaking changes to watch for, and how to upgrade your codebase smoothly to Node.js 24 LTS.'
image: '/blog/whats-new-in-nodejs-24/cover.png'
keywords: ['nodejs', 'nodejs 24', 'v8 engine', 'javascript', 'performance', 'upgrade', 'migration', 'lts', 'webassembly', 'npm 11', 'float16array', 'resource management', 'undici', 'typescript']
author: 'Zubair Ahmed'
showOnHome: true
---
